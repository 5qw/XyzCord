...
const (
	...
	// SingleColor causes XyzCord to take the color specified in the theme
	SingleColor UserColor = "single"
	// RandomColor causes XyzCord to take a random color from the theme
...
type Config struct {
	...
	Times int
	//UserColors decides how XyzCord determines in which color it displays
	...
	// ShortenLinks decides whether XyzCord starts a local webserver in order
	...
	// FileDownloadSaveLocation defines the folder where XyzCord generally
...
// XyzCord' settings from cache or sets it to the default
// location
